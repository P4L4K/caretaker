...
# Load DATABASE_URL from environment; default to SQLite for local dev
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./caretaker.db")

# SQLite needs a special connect arg; others (Postgres/MySQL) do not
